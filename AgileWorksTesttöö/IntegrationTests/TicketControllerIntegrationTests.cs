...
public class TicketControllerIntegrationTests: IClassFixture<CustomWebApplicationFactory<Program>>
{
    ...
    private async Task<HttpRequestMessage> PrepareTicketEditPostRequest(string description)
    {
    ...
    {
        //Arrange
        var postRequest = await PrepareTicketEditPostRequest("This is a description");
        //Act
    ...
    {
        //Arrange
        HttpRequestMessage postRequest = await PrepareTicketEditPostRequest("");
