...
public class HomeControllerIntegrationTests : IClassFixture<CustomWebApplicationFactory<Program>>
{
    ...
    public HomeControllerIntegrationTests(CustomWebApplicationFactory<Program> factory, ITestOutputHelper testOutputHelper)
    {
    ...
    public async Task<HttpRequestMessage> SetupTicketPostData(string description)
    {
